...
<div className="hotelContainer">
    {loading?<BeatLoader />:(
      ...
      return(
        <>
<div className="hotelWrapper" key={roomData._id}>
  <div className="hotelImage">
    <div className="MainHotelImage">
    <img class="card-img-top" src={`/Image/${roomData.img[1]}`} alt="Card cap"/>
    </div>
<div className="hotelImagePreview">
  {roomData.img.map((PreviewImage)=>{
    ...
    <img class="card-img-top" src={`/Image/${PreviewImage}`} alt="Card cap" onClick={()=>setShowImageCarousel(`/Image/${PreviewImage}`)}/>
    </div>
    </>
    )
  })}
...
showImageCarousel&&(
  ...
  <img class="card-img-top" src={`${showImageCarousel}`} alt="Card cap"/>
